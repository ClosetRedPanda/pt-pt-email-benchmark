            ...
            try:
                ...
                results.append({
                    ...
                    **res,
                    ...
                    # Issue 3: the defect-only score is the primary writing-quality
                    # metric for model comparison (uncompressed by the calibration
                    # ceiling); the calibrated score follows as the conservative one.
